...
RMAR Update Policy
- When asked to update RMAR, propose the best wording that captures the request's intent,
  is concise, and improves agent direction; then apply it, unless the user specifies exact wording.
